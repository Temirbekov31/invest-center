...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('addproject', '0020_alter_addproject_group_alter_addproject_region'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='addproject',
            name='region',
            field=models.CharField(choices=[('Osh', 'Osh'), ('Issyk-kul', 'Issyk-kul'), ('Naryn', 'Naryn'), ('Talas', 'Talas'), ('Chuy', 'Chuy'), ('Batken', 'Batken'), ('Jalal-abad', 'Jalal-abad')], max_length=20),
        ),
    ]
