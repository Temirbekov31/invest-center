(function($) {
    ...
    jQuery(document).ready(function($) {
        ...
        owlCarsouelActivate('.slider-sectffion', true, sliderResponsive, 5000, 1500, true, false, 1500, true, 30 );
        ...
        // owlCarsouelActivate('.jobDep', false, jobResponsive, 5000, 1500, true, false, 1500, true );


        

        //owl carousel activate function 
        function owlCarsouelActivate(selector, nav, responsive, autoplayTimeout, autoplaySpeed, dots = true, animateOut, smartSpeed, autoplayHoverPause, margin = 0, loop = true, autoplay = true) {
...
//   })
  ...
  console.log('efbebhjwfbkewfbewjkbewkjfewbkjfewbfjewbfewjkfbewjkfbewjkfb')
